...
* **Algorithmic Forex Trading**, I recently start to trade forex and written a forex swing trading strategy in mql5 and scalping strategy in pinescript based on a simple RSI. [Trading Strategy Collections](https://handiko.github.io/TradingStrategy-Public/), [Reverse RSI Strategy](https://github.com/handiko/Reverse-RSI-Forex-Strategy)
