...
* **Algorithmic Forex Trading**, I recently start to trading forex and written a forex scalping strategy based on a simple RSI. [Reverse RSI Strategy](https://github.com/handiko/Reverse-RSI-Forex-Strategy)
